...
module.exports = class SharedPen {
    constructor(cm, url) {
        ...
        this._sharedpenWrapper = Utils.elt('div', null, {
            class: 'sharedpen-wrapper'
        })
    ...
    insertLink() {
        if(this.cm.somethingSelected()){
            this.rtcm.insertLink('a', 'Insert Link url')
        }else{
            alert("请选中要插入链接的文字")
        }
    }
    ...
    //图片居中，先插入新行打断原有段落
    insertImage() {
        this.rtcm.insertImage('img', 'Insert Image url')
    }
