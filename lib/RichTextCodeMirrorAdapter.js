...
class RichTextCodeMirrorAdapter {
    ...
    static operationFromCodeMirrorChanges (changes, cm) {
        ...
        for (var i = changes.length - 1; i >= 0; i--) {
            ...
            if(restLength < 0 ){
                fromIndex = change.start - change.delen;
                change.start = fromIndex;
                change.end = change.total - change.end;
                change.text = change.inserted;
                restLength = docEndLength - fromIndex - change.inserted.length;
