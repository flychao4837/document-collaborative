...
const RichTextEditor = require('./RichTextCodeMirror.js')
const RichTextCodeEditorAdapter = require('./RichTextEditorAdapter.js')
...
module.exports = class togetherClient {
	constructor(editorDomID,url) {
		...
		this.editorAdapter = new RichTextCodeEditorAdapter(this.editorCtx)
