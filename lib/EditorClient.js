...
module.exports =
    class EditorClient extends Client {
        constructor(data, serverAdapter, editorAdapter) {
            ...
            super(data.revision, data.operations, data.document)
        ...
        sendOperation(revision, operation, selection) {
            this.serverAdapter.sendOperation(revision, operation.toJSON(), selection)
        };
        ...
        applyOperation(operation, optTag, selection) {
            ...
            if(optTag ==='initClientContent'){
                ...
                this.editorAdapter.applyOperation(operation, optTag, selection)
            }
        ...
        onChange(textOperation, inverse, selectionData) {
            ...
            this.applyClient(textOperation,selectionData)
