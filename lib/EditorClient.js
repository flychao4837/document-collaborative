...
module.exports =
    class EditorClient extends Client {
        constructor(data, serverAdapter, editorAdapter) {
            ...
            this.initClientContent(this.editorAdapter)
        ...
        //Fixed for wangEditor,初始化TextOperation，取出editor中带标签的文本长度
        initClientContent() {
            //TODO -- 根据服务端保存的历史记录来初始化文本编辑器
        ...
        onChange(textOperation, inverse) {
            console.log('--onChange--: ', textOperation)
                //textOperation 是当前操作的步骤

            //如果操作文本长度不变，那么一定是鼠标位置或选取变化来
