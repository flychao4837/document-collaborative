    ...
    this.targetLength = 0
        ...
        isNoop() {
            return this.ops.length === 0 ||
                (this.ops.length === 1 && this.ops[0].isRetain())
        }
        ...
        clone() {
            ...
            for (let i = 0; i < this.ops.length; i++) {
                if (this.ops[i].isRetain()) {
                    clone.retain(this.ops[i].chars)
                } else if (this.ops[i].isInsert()) {
                    clone.insert(this.ops[i].text)
                } else { // delete
        ...
        static transform(operation1, operation2) {
            ...
            while (true) {
                ...
                if (op1 && op1.isInsert()) {
                    operation1prime.insert(op1.text)
                ...
                if (op2 && op2.isInsert()) {
                    ...
                    operation2prime.insert(op2.text)
                    op2 = ops2[i2++]
                    continue
                }
