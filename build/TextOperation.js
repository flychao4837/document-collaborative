(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['module', './Utils.js', './TextAction.js'], factory);
    } else if (typeof exports !== "undefined") {
        factory(module, require('./Utils.js'), require('./TextAction.js'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod, global.Utils, global.TextAction);
        global.TextOperation = mod.exports;
    }
})(this, function (module, Utils, TextAction) {
    'use strict';
    ...
    module.exports = function () {
        ...
        _createClass(TextOperation, [{
            ...
            key: 'retain',
            value: function retain(n, attributes) {
                ...
                if (prevOp && prevOp.isRetain() && prevOp.attributesEqual(attributes)) {
                    ...
                    // => so we can merge them into one op.
                    prevOp.chars += n;
                } else {
            ...
            key: 'insert',
            value: function insert(str, attributes) {
                ...
                if (prevOp && prevOp.isInsert() && prevOp.attributesEqual(attributes)) {
                    ...
                    if (prevPrevOp && prevPrevOp.isInsert() && prevPrevOp.attributesEqual(attributes)) {
                        ...
                        this.ops[this.ops.length - 1] = new TextAction('insert', str, attributes);
